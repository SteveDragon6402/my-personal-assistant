...
import { WeightLogRepository } from './persistence/repositories/WeightLogRepository.js';
...
async function main(): Promise<void> {
  ...
  try {
    ...
    const notesAdapter = new DisabledNotesAdapter();
    ...
    const weightLogRepository = new WeightLogRepository();
